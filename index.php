                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">Makanan Lezat,<br>Sesuatu Untuk Semua Orang</h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2">Platform digital yang memberikan pengalaman baru bagi pelanggan dalam memesan makanan secara online, melakukan reservasi, dan mencari inspirasi kuliner.</p>
                            <a href="booking.php" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Booking Meja Sekarang!</a>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Master Chefs</h5>
                                <p>Dimasak oleh chefs profesional dan terkenal</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <p>Dengan bahan terbaik dan higenis. fresh langsung dari perkebunan</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <p>Menerima pesanan dimanapun dan kapanpun</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Melayani Setiap Hari</h5>
                                <p>Menerima pesanan tiap hari kecuali hari libur</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Restoranku</h1>
                        <p class="mb-4">Platform digital yang memberikan pengalaman baru bagi pelanggan dalam memesan makanan secara online, melakukan reservasi, dan mencari inspirasi kuliner. 
                            Restoranku didukung oleh ekosistem digital terintegrasi yang memudahkan segala kebutuhan operasional restoran.</p>
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="text-center">
                    ...
                    <h1 class="mb-5">Bukti Pelanggan Kita!!</h1>
                </div>
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                        <p>restoranku persis seperti yang saya cari.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-1.jpg" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Fara</h5>
                    ...
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                        <p>Kami tidak dapat memahami bagaimana kami hidup tanpa restoranku.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-2.jpg" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Anton</h5>
                                <small>Politikus</small>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                        <p>Pasti akan merekomendasikan restoranku dan pasti akan memesan lagi.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-3.jpg" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Muhammad Sumbul</h5>
                    ...
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                        <p>Saya suka restoranku! Ini adalah layanan yang luar biasa dan telah menghemat banyak waktu saya dan bisnis kecil saya. Saya berencana untuk menggunakannya untuk waktu yang lama.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-4.jpg" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Via</h5>
                                <small>Hairstylish</small>
                            </div>
                        </div>
                    </div>
                </div>
